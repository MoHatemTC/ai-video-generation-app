...
async def test_process_video_job_success(
    mock_to_thread, mock_generate_script, mock_planner_cls, mock_director_cls, mock_generate_voiceover, mock_alignment_service, mock_process_scene, mock_script_data
):
